  ...
  <section className={"aboutSection"}>
    <div className={"aboutSection__text"}>
      ...
      <p>Nuestra empresa se fundó a raíz de un viaje que nuestra fundadora, Marina Herrán, realizó en bicicleta por
        ...
        Cataluña.</p>
      <p>Preocupada por la falta de altenativas eco-friendly, Marina se propuso fundar una agencia de experiencias
        turísticas donde el respeto por la naturaleza fuera la principal prioridad. Así nació Econotravel Barcelona.</p>
    </div>
