...
export const About = () => <section className={"aboutSection"}>
    <div className={"aboutSection__text"}>
        <h3>Quienes Somos</h3>
        <p className={"text--intro"}>¡Hola! Somos Econotravel, un equipo de entusiastas de la naturaleza que lleva desde 2003 ofreciendo experiencias turísticas eco-friendly en el área de Barcelona.</p>
