            ...
            <div className="wrapper">
                ...
                <div className="reservas">
                    <div className="reservas__description">
                        ...
                        <p className="reservas__text">El recorrido que os proponemos comienza con una larga subida con algunos descansos, combinando
                        ...
                        <p className="last"> Para finalizar, acudiremos al restaurante María Rosa de Palautordera, donde disfrutaremos de una excelente comida casera
